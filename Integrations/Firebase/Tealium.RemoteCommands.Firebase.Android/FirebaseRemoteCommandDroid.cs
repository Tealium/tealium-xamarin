...
namespace Tealium.RemoteCommands.Firebase.Droid
{
    ...
    public class FirebaseRemoteCommandDroid : FirebaseRemoteCommand, IRemoteCommand
    {
...

        {
            ...
            eventsMap.Add("add_payment_info", FirebaseAnalytics.Event.AddPaymentInfo);

            eventsMap.Add("add_to_cart", FirebaseAnalytics.Event.AddToCart);

            eventsMap.Add("add_to_wishlist", FirebaseAnalytics.Event.AddToWishlist);

            eventsMap.Add("app_open", FirebaseAnalytics.Event.AppOpen);
